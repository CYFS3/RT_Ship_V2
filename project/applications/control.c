...
int pwm_init(void)
{
    ...
    control_dev_1.cfg.period = 5000;
    control_dev_1.cfg.pulse = 5000 + 1;
    ...
    rt_pin_write(CONTROL_PIN_2, PIN_HIGH);
}
...
{
    rt_pwm_set(control_dev_1.pwm_dev, PWM_DEV_CHANNEL,control_dev_1.cfg.period, control_dev_1.cfg.period + 1);
}
